...
class ControllerIcons : Node() {
    ...
    companion object {
        var instance: ControllerIcons? = null
            private set
    }
    ...
    fun parsePath(
        ...
        inputType: InputType = lastInputType,
        controller: Int = lastController,
        forcedControllerIconStyle: ControllerSettings.Devices = ControllerSettings.Devices.NONE,
    ): Texture2D? {
    ...
    fun parseEventModifiers(event: InputEvent?): List<Texture2D> {
        ...
        for (modifier in modifiers) {
            for (iconPath in expandPath(modifier, InputType.KEYBOARD_MOUSE, -1, ControllerSettings.Devices.NONE)) {
    ...
    private fun expandPath(
        ...
        inputType: InputType,
        controller: Int,
        forcedControllerIconStyle: ControllerSettings.Devices,
    ): List<String> {
