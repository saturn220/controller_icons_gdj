...
@RegisterClass
class JvmControllerSprite2D : Sprite2D() {
    ...
    private fun ensureSignalConnection(icons: JvmControllerIcons) {
        ...
        connectedIcons?.input_type_changed?.disconnect(this, JvmControllerSprite2D::onInputTypeChanged)
        icons.input_type_changed.connect(this, JvmControllerSprite2D::onInputTypeChanged)
