...
@RegisterClass
class JvmControllerButton : Button() {
    ...
    private fun ensureSignalConnection(icons: JvmControllerIcons) {
        ...
        connectedIcons?.input_type_changed?.disconnect(this, JvmControllerButton::onInputTypeChanged)
        icons.input_type_changed.connect(this, JvmControllerButton::onInputTypeChanged)
